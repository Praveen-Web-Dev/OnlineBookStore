...
namespace BulkyWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        {
            var calimsIdentity = (System.Security.Claims.ClaimsIdentity)User.Identity;
            var userId = calimsIdentity.FindFirst(System.Security.Claims.ClaimTypes.NameIdentifier).Value;
       ...
       ApplicationUser applicationUser = _unitOfWork.ApplicationUser.GetFirstOrDefault(u => u.Id == userId);
        ...
        {
            var cartFromDb = _unitOfWork.ShoppingCart.GetFirstOrDefault(u => u.Id == cartId);
            if (cartFromDb == null)   // ✅ Prevents crash
            {
                return NotFound();
            }
